...
public partial class DbA85d0bFutboleandobdContext : DbContext
{
    ...
    public virtual DbSet<Cuotaequipo> Cuotaequipos { get; set; }

    public virtual DbSet<Cuotatorneo> Cuotatorneos { get; set; }
    ...
    public virtual DbSet<Pagoequipo> Pagoequipos { get; set; }
