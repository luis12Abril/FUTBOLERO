...
{
    public partial class FUTBOLEANDOContext : DbContext
    {
        public FUTBOLEANDOContext()
        {
        }

        public FUTBOLEANDOContext(DbContextOptions<FUTBOLEANDOContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Ligacolegio> Ligacolegio { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ligacolegio>(entity =>
            {
                entity.HasKey(e => e.Idligacolegio);

                entity.ToTable("LIGACOLEGIO");

                entity.Property(e => e.Idligacolegio).HasColumnName("IDLIGACOLEGIO");
            ...
            modelBuilder.Entity<Torneocolegio>(entity =>
            {
                entity.HasKey(e => e.Idtorneocolegio);

                entity.ToTable("TORNEOCOLEGIO");
